...
object Patches {
    ...
    val ZunBass1 = FmPatch(
        ...
        op0 = OperatorSpec(mul = 1, detune = 0, tl = 0,  modulationIndex = 2.0f, attack = 0.002f, decay = 0.030f, sustain = 0.0f, release = 0.020f),
        op1 = OperatorSpec(mul = 1, detune = 4, tl = 16, modulationIndex = 1.5f, attack = 0.002f, decay = 0.040f, sustain = 0.0f, release = 0.030f),
        op2 = OperatorSpec(mul = 1, detune = 0, tl = 12, modulationIndex = 0f,   attack = 0.002f, decay = 0.050f, sustain = 0.0f, release = 0.050f),
